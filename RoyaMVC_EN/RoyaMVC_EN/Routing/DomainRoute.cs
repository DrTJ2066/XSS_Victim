...
namespace RoyaMVC_EN.Routing
{
    ...
    public class DomainRoute : Route
    {
        ...
        public DomainRoute(string domain, string url, object defaults) : this(domain, url, new RouteValueDictionary(defaults), new MvcRouteHandler()) { }
        ...
        public DomainRoute(string domain, string url, object defaults, IRouteHandler routeHandler) : this(domain, url, new RouteValueDictionary(defaults), routeHandler) { }
        ...
        public DomainRoute(string domain, string url, RouteValueDictionary defaults) : this(domain, url, defaults, new MvcRouteHandler()) { }
        ...
        {
            // Request information
            System.Diagnostics.Debug.Print(httpContext.Request.Url.OriginalString);
            ...
            System.Diagnostics.Debug.Print("domainMatch is : " + ((domainMatch == null) ? "Null" : "Not Null"));
            if (domainMatch.Success == false) return null;

            RouteData data = base.GetRouteData(httpContext);
            System.Diagnostics.Debug.Print("Data is : {0}\n\t{1}", ((data == null) ? "Null" : "Not Null"), requestDomain);
                ...
                if (group.Success)
                {
                    ...
                    if (!string.IsNullOrEmpty(key) && !char.IsNumber(key, 0))
                    {
                        if (!string.IsNullOrEmpty(group.Value))
                        {
                            ...
                            System.Diagnostics.Debug.Print("---> Data: {0}, Value: {1}\n", key, group.Value);
                        }
                    }
                }
            }
